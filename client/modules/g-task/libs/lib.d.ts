...
interface Date {
    ...
    clearTime():Date;
    clearUTCTime():Date;
    add(obj:{milliseconds:number; seconds:number; minutes:number; hours:number; days:number; weeks:number; months:number; years:number}):Date;
    ...
    addWeekdays(weekdays:number):string;
    remove(obj:{milliseconds:number; seconds:number; minutes:number; hours:number; days:number; weeks:number; months:number; years:number}):Date;
    removeMilliseconds(milliseconds:number):Date;
    removeSeconds(seconds:number):Date;
    removeMinutes(minutes:number):Date;
    removeHours(hours:number):Date;
    removeDays(days:number):Date;
    removeWeeks(weeks:number):Date;
    removeMonths(months:number):Date;
    removeYears(years:number):Date;
    setTimeToNow():void;
    clone():Date;
...
declare var Date: {
    ...
    validateMillisecond(milli:number):boolean;
    validateHour(hour:number):boolean;
    compare(date1:Date, date2:Date):number;
    equals(date1:Date, date2:Date):boolean;
    equalsDay(date1:Date, date2:Date):boolean;
    getDayNumberFromName(name:string):number;
    getMonthNumberFromName(name:string):number;
    getMonthNameFromNumber(name:string):number;
    getMonthAbbrFromNumber(name:string):number;
    getDaysInMonth(year:number, month:number):number;
    isLeapYear(year:number):boolean;
    //=====================================date-utils end================================
    //=====================================newDate begin==========================
    /**
     * 获取当前时间，需要注意的是，以后获取当前时间不是用`new Date`，而是调用该接口。
     * @param date
     * @returns {Date}
     */
    setStandard(date?:any):void;
    /**
     * 获取当前游戏时间
     * @param date
     * @returns {Date}
