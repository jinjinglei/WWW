...
module g_activity{
    ...
    export class ActivityAppMysteryShop extends mo.gui.Dlg {
        label_curScore;
        label_yuanbao;
        ...
        _tap_btn_exchange0() {
            var self = this;
            ActivityAppMysteryExchangeDlg.create().setData({exActivity:self.data.exActivity, index:0}).show().onClose(function(){
                self.reset();
            });
        }
        ...
        _tap_btn_exchange1() {
            var self = this;
            ActivityAppMysteryExchangeDlg.create().setData({exActivity:self.data.exActivity, index:1}).show().onClose(function(){
                self.reset();
            });
        }
        ...
        _tap_btn_exchange2() {
            var self = this;
            ActivityAppMysteryExchangeDlg.create().setData({exActivity:self.data.exActivity, index:2}).show().onClose(function(){
                self.reset();
            });
        }
