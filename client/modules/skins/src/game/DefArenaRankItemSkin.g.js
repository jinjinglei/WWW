...
(function (skins) {
    var game;
    (function (game) {
        var DefArenaRankItemSkin = (function (_super) {
            __extends(DefArenaRankItemSkin, _super);
            function DefArenaRankItemSkin() {
                _super.call(this);
                this.__s = egret.gui.setProperties;
                this.height = 124;
                this.elementsContent = [this.__4_i(), this.__5_i(), this.label_name_i(), this.__8_i(), this.__10_i(), this.label_rank_i(), this.__11_i(), this.ico_rank_i(), this.grp_res0_i(), this.grp_res1_i(), this.grp_res2_i(), this.ico_head_i()];
                this.states = [
            ...
            var d = __define,c=DefArenaRankItemSkin,p=c.prototype;
            d(p, "skinParts"
                ,function () {
                    return DefArenaRankItemSkin._skinParts;
                }
            );
            p.__11_i = function () {
            ...
            p.grp_res1_i = function () {
                var t = new egret.gui.Group();
                this.grp_res1 = t;
                this.__s(t, ["height", "x", "y"], [30, 242, 89]);
            ...
            p.grp_res2_i = function () {
                var t = new egret.gui.Group();
                this.grp_res2 = t;
                this.__s(t, ["height", "x", "y"], [30, 342, 89]);
            ...
            DefArenaRankItemSkin._skinParts = ["label_name", "label_lvl", "label_title", "label_combat", "label_rank", "ico_rank", "grp_res0", "grp_res1", "grp_res2", "ico_head"];
            return DefArenaRankItemSkin;
        })(egret.gui.Skin);
        game.DefArenaRankItemSkin = DefArenaRankItemSkin;
        egret.registerClass(DefArenaRankItemSkin,"skins.game.DefArenaRankItemSkin");
