...
(function (skins) {
    var game;
    (function (game) {
        var BossCopyItemSkin = (function (_super) {
            __extends(BossCopyItemSkin, _super);
            function BossCopyItemSkin() {
                _super.call(this);
            ...
            var d = __define,c=BossCopyItemSkin,p=c.prototype;
            d(p, "skinParts"
                ,function () {
                    return BossCopyItemSkin._skinParts;
                }
            );
            p.__5_i = function () {
            ...
            BossCopyItemSkin._skinParts = ["img_lock", "img_boss", "label_name"];
            return BossCopyItemSkin;
        })(egret.gui.Skin);
        game.BossCopyItemSkin = BossCopyItemSkin;
        egret.registerClass(BossCopyItemSkin,"skins.game.BossCopyItemSkin");
