...
(function (skins) {
    var game;
    (function (game) {
        var ActivityNewRchgSkin = (function (_super) {
            __extends(ActivityNewRchgSkin, _super);
            function ActivityNewRchgSkin() {
                _super.call(this);
            ...
            var d = __define,c=ActivityNewRchgSkin,p=c.prototype;
            d(p, "skinParts"
                ,function () {
                    return ActivityNewRchgSkin._skinParts;
                }
            );
            p.__11_i = function () {
            ...
            p.__18_i = function () {
                var t = new egret.gui.Group();
                this.__s(t, ["height", "horizontalCenter", "touchChildren", "touchEnabled", "width", "x", "y"], [544, 0, true, true, 430, 10, 209]);
                t.layout = this.__7_i();
            ...
            ActivityNewRchgSkin._skinParts = ["head", "btn_close", "btn_help", "label_activity_time", "label_activity_desc", "label_all_charge", "list_items"];
            return ActivityNewRchgSkin;
        })(egret.gui.Skin);
        game.ActivityNewRchgSkin = ActivityNewRchgSkin;
        egret.registerClass(ActivityNewRchgSkin,"skins.game.ActivityNewRchgSkin");
