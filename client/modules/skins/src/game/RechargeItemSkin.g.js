...
(function (skins) {
    var game;
    (function (game) {
        var RechargeItemSkin = (function (_super) {
            __extends(RechargeItemSkin, _super);
            function RechargeItemSkin() {
                _super.call(this);
                this.__s = egret.gui.setProperties;
                this.width = 390;
                this.elementsContent = [this.__4_i(), this.__5_i(), this.__6_i(), this.ico_recharge_i(), this.label_yb2_i(), this.btn_rmb_i(), this.ico_remai_i(), this.ico_tuijian_i(), this.ico_3bei_i(), this.__9_i(), this.__12_i()];
                this.states = [
            ...
            var d = __define,c=RechargeItemSkin,p=c.prototype;
            d(p, "skinParts"
                ,function () {
                    return RechargeItemSkin._skinParts;
                }
            );
            p.__11_i = function () {
            ...
            p.__7_i = function () {
                var t = new egret.gui.UIAsset();
                this.__s(t, ["source", "x", "y"], ["ico_yuan", 49, 0]);
                return t;
            };
            p.__8_i = function () {
                var t = new egret.gui.HorizontalLayout();
                this.__s(t, ["gap", "verticalAlign"], [0, "bottom"]);
                return t;
            };
            p.__9_i = function () {
                var t = new egret.gui.Group();
                this.__s(t, ["horizontalCenter", "top"], [135.5, 15]);
                t.layout = this.__8_i();
            ...
            p.btn_rmb_i = function () {
                ...
                this.btn_rmb = t;
                this.__s(t, ["right", "scaleX", "scaleY", "skinName", "top"], [10, 0.8, 0.8, new egret.gui.ButtonSkin("btn_recharge_1", "btn_recharge_0"), 14]);
                return t;
            };
            p.ico_3bei_i = function () {
                var t = new egret.gui.UIAsset();
                this.ico_3bei = t;
                this.__s(t, ["source", "visible", "x", "y"], ["ntc_recharge_3", false, 0, 2]);
                return t;
            };
            ...
            p.label_cost_i = function () {
                ...
                this.label_cost = t;
                this.__s(t, ["font", "text", "x", "y"], ["num_10", "000", 0, 0]);
                return t;
            };
            ...
            RechargeItemSkin._skinParts = ["ico_recharge", "label_yb2", "btn_rmb", "ico_remai", "ico_tuijian", "ico_3bei", "label_cost", "label_yb"];
            return RechargeItemSkin;
        })(egret.gui.Skin);
        game.RechargeItemSkin = RechargeItemSkin;
        egret.registerClass(RechargeItemSkin,"skins.game.RechargeItemSkin");
