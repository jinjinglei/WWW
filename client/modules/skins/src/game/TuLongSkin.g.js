...
(function (skins) {
    var game;
    (function (game) {
        var TuLongSkin = (function (_super) {
            __extends(TuLongSkin, _super);
            function TuLongSkin() {
                _super.call(this);
            ...
            var d = __define,c=TuLongSkin,p=c.prototype;
            d(p, "skinParts"
                ,function () {
                    return TuLongSkin._skinParts;
                }
            );
            p.__11_i = function () {
            ...
            TuLongSkin._skinParts = ["list_items", "bar_recharge", "label_vip", "grp_equip0", "grp_equip1", "grp_equip2", "btn_close", "grp_recharge"];
            return TuLongSkin;
        })(egret.gui.Skin);
        game.TuLongSkin = TuLongSkin;
        egret.registerClass(TuLongSkin,"skins.game.TuLongSkin");
