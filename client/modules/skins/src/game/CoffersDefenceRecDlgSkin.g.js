...
(function (skins) {
    var game;
    (function (game) {
        var CoffersDefenceRecDlgSkin = (function (_super) {
            __extends(CoffersDefenceRecDlgSkin, _super);
            function CoffersDefenceRecDlgSkin() {
                _super.call(this);
            ...
            var d = __define,c=CoffersDefenceRecDlgSkin,p=c.prototype;
            d(p, "skinParts"
                ,function () {
                    return CoffersDefenceRecDlgSkin._skinParts;
                }
            );
            p.__4_i = function () {
            ...
            CoffersDefenceRecDlgSkin._skinParts = ["btn_close", "list_rec"];
            return CoffersDefenceRecDlgSkin;
        })(egret.gui.Skin);
        game.CoffersDefenceRecDlgSkin = CoffersDefenceRecDlgSkin;
        egret.registerClass(CoffersDefenceRecDlgSkin,"skins.game.CoffersDefenceRecDlgSkin");
