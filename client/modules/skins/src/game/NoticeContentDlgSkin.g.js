...
(function (skins) {
    var game;
    (function (game) {
        var NoticeContentDlgSkin = (function (_super) {
            __extends(NoticeContentDlgSkin, _super);
            function NoticeContentDlgSkin() {
                _super.call(this);
            ...
            var d = __define,c=NoticeContentDlgSkin,p=c.prototype;
            d(p, "skinParts"
                ,function () {
                    return NoticeContentDlgSkin._skinParts;
                }
            );
            p.__4_i = function () {
                var t = new egret.gui.Group();
                this.__s(t, ["width", "x", "y"], [409, 129, 27]);
            ...
            NoticeContentDlgSkin._skinParts = ["ico_head", "label_text", "scl_Content", "label_title", "btn_close"];
            return NoticeContentDlgSkin;
        })(egret.gui.Skin);
        game.NoticeContentDlgSkin = NoticeContentDlgSkin;
        egret.registerClass(NoticeContentDlgSkin,"skins.game.NoticeContentDlgSkin");
