...
(function (skins) {
    var game;
    (function (game) {
        var ActivityNewLimitBuySkin = (function (_super) {
            __extends(ActivityNewLimitBuySkin, _super);
            function ActivityNewLimitBuySkin() {
                _super.call(this);
            ...
            var d = __define,c=ActivityNewLimitBuySkin,p=c.prototype;
            d(p, "skinParts"
                ,function () {
                    return ActivityNewLimitBuySkin._skinParts;
                }
            );
            p.__11_i = function () {
            ...
            p.label_buy_count_i = function () {
                ...
                this.__s(t, ["height", "horizontalCenter", "size", "text", "textAlign", "width", "y"], [27, 0, 16, "当前已购买x2", "center", 351, 303]);
                return t;
            };
            p.label_vipHint_i = function () {
                var t = new egret.gui.Label();
                this.label_vipHint = t;
                this.__s(t, ["height", "horizontalCenter", "size", "text", "textAlign", "textColor", "width", "x", "y"], [27, 0.5, 16, "vip4及以上才可购买", "center", 0xFF0000, 351, 20, 330]);
                return t;
            };
            ...
            ActivityNewLimitBuySkin._skinParts = ["head", "btn_close", "btn_help", "label_activity_time", "label_activity_desc", "list_items", "btn_buy", "ico_hasGet", "label_buy_count", "label_vipHint", "ico_cost_icon", "label_yuanbao_cost", "ico_have_icon", "label_yuanbao_left"];
            return ActivityNewLimitBuySkin;
        })(egret.gui.Skin);
        game.ActivityNewLimitBuySkin = ActivityNewLimitBuySkin;
        egret.registerClass(ActivityNewLimitBuySkin,"skins.game.ActivityNewLimitBuySkin");
