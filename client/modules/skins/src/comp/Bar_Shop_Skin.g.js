...
(function (skins) {
    var comp;
    (function (comp) {
        var Bar_Shop_Skin = (function (_super) {
            __extends(Bar_Shop_Skin, _super);
            function Bar_Shop_Skin() {
                _super.call(this);
            ...
            var d = __define,c=Bar_Shop_Skin,p=c.prototype;
            d(p, "skinParts"
                ,function () {
                    return Bar_Shop_Skin._skinParts;
                }
            );
            p.__4_i = function () {
            ...
            p.__3_i = function () {
                ...
                this.__s(t, ["source", "verticalCenter", "width", "x"], ["bar_bg_shop", 0, 350, 0]);
                return t;
            };
            p.thumb_i = function () {
                var t = new egret.gui.UIAsset();
            ...
            Bar_Shop_Skin._skinParts = ["track", "thumb", "labelDisplay"];
            return Bar_Shop_Skin;
        })(egret.gui.Skin);
        comp.Bar_Shop_Skin = Bar_Shop_Skin;
        egret.registerClass(Bar_Shop_Skin,"skins.comp.Bar_Shop_Skin");
